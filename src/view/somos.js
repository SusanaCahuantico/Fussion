export default () => {
    ...
    <div class="container"> 
        <div class="row">
          ...
          <div class="col-5">
           <img src="./image/tortuga.jpg" class="img-somos img-circle float-right rounded-circle">
          </div>
        </div>
        <div class="row">
          <div class="box-que col-5">
          ...
          <div class="col-5">
           <img src="./image/fotosface1.jpg" class="img-somos float-right rounded-circle">
          </div>
        </div>
        <div class="row">
           <div class="box-que col-5"> 
           ...
           <div class="col-5">
           <img src="./image/tortuga.jpg" class="img-somos float-right rounded-circle">
           </div>
        </div>
        <div class="row">
          <div class="box-que col-5">
          ...
          <div class="col-5">
           <img src="./image/save.jpg" class="img-somos img-top float-right rounded-circle">
          </div>
        </div> 
    </div>
    `;
